  ...
  protected  static void calculateAlphabetCombinations(List<String> combinationList, String prefixVar, String remainingVar) {
    ...
    public static void main(String[] args) {
      List<String> result= new LinkedList<>();
        List<String> result2= new ArrayList<String>(Arrays.asList(new String[]{"A","B","C"}));

        result= retrieveCombinations("9987");
        System.out.println("The result is"+result.toString()+"size:"+result.size());
        System.out.println("The result is"+result2.toString()+"size:"+result2.size());
